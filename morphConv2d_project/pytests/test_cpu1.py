...
# Small tensors, K=3, stride=1, padding=0, no bias, no dead neurons
def test_cpu1(i, use_64=False):
    print(f"===============  Test 1.{i} (start)  ================\n")
    B = 1; C_in = 1; C_out = 1; H_in = 3; W_in = 3; H_out = 1; W_out = 1; K = 3; stride = 1; padding = 0
    
    test_cpu(B, C_in, C_out, H_in, W_in, H_out, W_out, K, stride, padding, False, False, use_64)
