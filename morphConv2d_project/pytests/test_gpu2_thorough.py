...
# More channels, resol=4x4 K=3, with stride=3, with padding=1, no bias, no dead neurons
def test_gpu2(i, use_64=False):
    print(f"===============  Test 2.{i} (start)  ================\n")
