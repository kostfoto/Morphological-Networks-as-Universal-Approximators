...
# More channels, resol=4x4 K=3, with stride=3, with padding=1, with bias, no dead neurons
def test_gpu3(i, use_64=False):
    print(f"===============  Test 3.{i} (start)  ================\n")
    B = 1; C_in = 3; C_out = 3; H_in = 4; W_in = 4; H_out = 2; W_out = 2; K = 3; stride = 3; padding = 1
    
    test_gpu(B, C_in, C_out, H_in, W_in, H_out, W_out, K, stride, padding, True, False, use_64)
    print(f"================  Test 3.{i} (end)  =================\n")
